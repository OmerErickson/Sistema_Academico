      ...
      <div class="main_container">
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Relacion de Datos Institucionales</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $b_dato_institucional = buscarDatos_institucionales($conexion);
                        while ($res_b_dato_institucional = mysqli_fetch_array($b_dato_institucional)) {
                        ?>
                        <tr>
                          <td><?php echo $res_b_dato_institucional['id']; ?></td>
                          <td><?php echo $res_b_dato_institucional['cod_modular']; ?></td>
                          <td><?php echo $res_b_dato_institucional['ruc'];  ?></td>
